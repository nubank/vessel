...
(def working-dir (io/file "target/tests/program-integration-test"))
  ...
  (providing [(#'vessel/exit int?) (calling identity)]
             ...
             (testing "generates a manifest file containing metadata about the
               ...
               (is (zero? (vessel/-main "manifest"
                                        ...
                                        "--object" "service"
                                        "--output" (str (io/file working-dir "my-app.json")))))

               (is (= {:service {:name       "my-app"
                                 :git-commit "07dccc801700cbe28e4a428e455b4627e0ab4ba9"}}
                      (misc/read-json (io/file working-dir "my-app.json")))))
             ...
             (testing "generates a manifest file describing the base image"
               (is (zero? (vessel/-main "image"
                                        ...
                                        "--output" (str (io/file working-dir "openjdk-alpine.json")))))
               ...
               (is (= {:image
                      ...
                      (misc/read-json (io/file working-dir "openjdk-alpine.json")))))
             ...
             (testing "generates a manifest file describing the application's
               ...
               (is (zero? (vessel/-main "image"
                                        ...
                                        "--base-image" (str (io/file working-dir "openjdk-alpine.json"))
                                        "--merge-into" (str (io/file working-dir "my-app.json"))
                                        "--output" (str (io/file working-dir "image.json")))))
               ...
               (is (= {:image
                       ...
                       {:name       "my-app"
                        :git-commit "07dccc801700cbe28e4a428e455b4627e0ab4ba9"}}
                      (misc/read-json (io/file working-dir "image.json")))))))
