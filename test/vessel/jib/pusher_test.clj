...
(deftest make-registry-client-test
  ...
  the registry"
    (verifying [(pusher/make-docker-config-retriever (a ImageReference)) credential-retriever (exactly 1)
  ...
  credentials nor to authenticate on the registry"
    (verifying [(pusher/make-docker-config-retriever (a ImageReference)) any (exactly 0)
